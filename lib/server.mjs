...
export function createServer({ createEvent, createContext, handlerName, handlerFn }) {
  assert(typeof createEvent === 'function', 'Expected createEvent to be a function');
  assert(typeof createContext === 'function', 'Expected createContext to be a function');
  assert(typeof handlerName === 'string', 'Expected handlerName to be a string');
  assert(typeof handlerFn === 'function', 'Expected handlerFn to be a function');
